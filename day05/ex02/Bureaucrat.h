...
#ifndef DAY05_EX02_BUREAUCRAT_H_
#define DAY05_EX02_BUREAUCRAT_H_
...
class Bureaucrat {
 public:
  ...
  static unsigned MinGrade(void);
  static unsigned MaxGrade(void);
...
#endif  // DAY05_EX02_BUREAUCRAT_H_
